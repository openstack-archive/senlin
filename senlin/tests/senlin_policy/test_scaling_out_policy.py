...
from senlin.policies import scaling_out_policy
from senlin.tests.common import base
from senlin.tests.common import utils


class TestScalingOutPolicy(base.SenlinTestCase):
    ...
    def test_policy_init(self):
        ...
        policy = scaling_out_policy.ScalingOutPolicy('ScalingOutPolicy',
                                                     'test-policy',
                                                     **kwargs)
    ...
    def test_pre_op_fail_exceed_max_size(self):
        action = mock.Mock()
        action.context = self.context
        action.inputs = {}
        kwargs = {
